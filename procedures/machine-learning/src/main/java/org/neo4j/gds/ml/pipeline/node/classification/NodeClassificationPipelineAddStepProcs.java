...
public class NodeClassificationPipelineAddStepProcs {
    ...
    public Stream<NodePipelineInfoResult> addNodeProperty(
        ...
        return facade.pipelines().nodeClassification().addNodeProperty(pipelineName, taskName, procedureConfig, null);
    }
    ...
    public Stream<NodePipelineInfoResult> selectFeatures(
        ...
        return facade.pipelines().nodeClassification().selectFeatures(pipelineName, nodeProperties, null);
    }
}
