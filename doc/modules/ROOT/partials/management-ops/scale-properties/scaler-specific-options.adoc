...
| type          | String | n/a     | no       | Type of the scaler applied for the properties. Supported values are `MinMax`, `Max`, `Mean`, `Log`, `Center`, `StdScore`, `L1Norm`, and `L2Norm`, case insensitively.
