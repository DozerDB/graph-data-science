...
public final class UncompressedCompressorProvider implements AdjacencyCompressorProvider {
    ...
    public MemoryEstimation adjacencyListEstimation(long avgDegree, long nodeCount) {
        return UncompressedAdjacencyList.adjacencyListEstimation(avgDegree, nodeCount);
    }

    @Override
    public MemoryEstimation adjacencyListEstimation(RelationshipType type, boolean undirected) {
        return UncompressedAdjacencyList.adjacencyListEstimation(type, undirected);
    }
}
