...
public final class PackedCompressorProvider implements AdjacencyCompressorProvider {

    @Override
    public CompressionKind kind() {
        return CompressionKind.PACKED;
    }
    ...
    // PackedAdjacencyList does not expose static memory-estimation methods.
    // TODO: implement estimation once packed list bit-width analysis is available.
    @Override
